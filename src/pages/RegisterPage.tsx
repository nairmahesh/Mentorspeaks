...
import { Video, ChevronRight, ChevronLeft, Briefcase, DollarSign, Heart, Folder, UserCircle, GraduationCap } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex space-x-4 pt-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
