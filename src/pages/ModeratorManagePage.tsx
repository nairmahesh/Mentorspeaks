                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                      mod.is_admin ? 'bg-gradient-to-br from-yellow-400 to-cyan-500' : 'bg-blue-100'
                    }`}>
                      {mod.is_admin ? (
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2">
                        ...
                        {mod.is_admin && (
                          <span className="bg-gradient-to-r from-yellow-400 to-cyan-500 text-white text-xs px-2 py-1 rounded-full font-semibold">
                            ADMIN
                          </span>
                        )}
                      </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ul className="text-sm text-blue-800 space-y-2">
            <li className="flex items-start space-x-2">
              <Crown className="w-4 h-4 mt-0.5 text-cyan-500" />
